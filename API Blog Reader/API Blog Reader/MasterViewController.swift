...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://www.googleapis.com/blogger/v3/blogs/2120328063286836889/posts?key=AIzaSyACb2IP8m6-ZpCPcf87oUtZcbvYGiXchZU")!
        let task = URLSession.shared.dataTask(with: url) {
            data, response, error in
            if let foundError = error {
                print("ERROR: \(foundError)")
            } else {
                    ...
                    do {
                        ...
                        if let items = jsonResult["items"] as? NSArray {
                            ...
                            for item in items as [AnyObject] {
                                let newEvent = Event(context: context) // new object in database
                        ...
                        // THIS WILL BE EXECUTED WHEN THE ABOVE PROCESS HAS FINISHED RUNNING
                        // UI UPDATES INCLUDING RELOADING TABLE DATA
